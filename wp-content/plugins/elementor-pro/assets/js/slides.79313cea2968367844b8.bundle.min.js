      ...
      class SlidesHandler extends elementorModules.frontend.handlers
        ...
        getSwiperOptions() {
          const e = this.getElementSettings(),
            ...
            i = "arrows" === e.navigation || "both" === e.navigation,
        ...
        async initSlider() {
          const e = this.elements.$swiperContainer,
            ...
            s = e.data(t.attributes.dataAnimation);
          if (!e.length) return;
          if (1 >= this.getSlidesCount()) return;
          const n = elementorFrontend.utils.swiper;
          (this.swiper = await new n(e, this.getSwiperOptions())),
            ...
            s &&
              (this.swiper.on("slideChangeTransitionStart", function () {
                e.find(t.selectors.slideInnerContents)
                  .removeClass(t.classes.animated + " " + s)
                  .hide();
              }),
              this.swiper.on("slideChangeTransitionEnd", function () {
                e.find(t.selectors.slideInnerContents)
                  .show()
                  .addClass(t.classes.animated + " " + s);
              }));
        }
        onInit() {
        ...
        updateSwiperOption(e) {
          ...
          "pause_on_hover" !== e && (this.swiper.params[s] = n),
            this.swiper.update();
        }
        onElementChange(e) {
          if (1 >= this.getSlidesCount()) return;
