  ...
  [723],
  {
    ...
    4508: (e, t, n) => {
      ...
      class IconsManager {
        ...
        createSvgElement(e, { path: t, width: n, height: i }) {
        ...
        createSvgNode(e, { props: t = {}, attrs: n = {} }) {
          const i = document.createElementNS("http://www.w3.org/2000/svg", e);
          return (
            Object.keys(t).map((e) => (i[e] = t[e])),
            Object.keys(n).map((e) => i.setAttributeNS(null, e, n[e])),
            i
          );
        }
        ...
        createSymbolElement({ id: e, path: t, width: n, height: i }) {
      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        setVideoContent: function (e) {
          ...
          if ("hosted" === e.videoType) {
            ...
            l = t("<iframe>", {
              src: n.getAutoplayURL(e.url),
              allowfullscreen: 1,
            });
          }
          i.append(s), s.append(l), o.setMessage(i), this.setVideoAspectRatio();
          const a = o.onHide;
          o.onHide = function () {
            a(),
              (this.$buttons = jQuery()),
        ...
        createShareLink: function (e, t, n = null) {
          const i = {};
          return (
            "pinterest" === e
        ...
        setSlideshowContent: function (e) {
          ...
          if (
            ...
            (m = n("<div>", {
              ...
              c.append(u, m),
              (this.$buttons = this.$buttons.add(u).add(m));
          }
          a &&
        ...
        playSlideVideo: function () {
          ...
          a.onApiReady((e) => {
            "youtube" === l
              ? this.prepareYTVideo(e, r, i, s, o)
              : "vimeo" === l && this.prepareVimeoVideo(e, t, i, s, o);
          }),
            o.addClass(n.playing).removeClass(n.hidden);
        },
